# Demo for working with GESIS AppKit data
...
- Login Page: [https://admin.appkit.gesis.org/login](https://admin.appkit.gesis.org/login)
- Website: [https://www.gesis.org/gesis-appkit](https://www.gesis.org/gesis-appkit)
- Mailing List: [https://lists.gesis.org/mailman/listinfo/gesis-appkit](https://lists.gesis.org/mailman/listinfo/gesis-appkit)
- Preprint of tool paper: [https://osf.io/preprints/socarxiv/q8v72_v1](https://osf.io/preprints/socarxiv/q8v72_v1)
- Open source code: https://gitlab.com/gesis-appkit
- GitLab repo for the `appkitr` package: https://gitlab.com/gesis-appkit/appkitr
- Manual: [https://appkit.gesis.org/manual/](https://appkit.gesis.org/manual/)
